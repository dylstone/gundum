 ...
 */
@Entity
public class ApplySvcMail extends BaseEntity {

	/** 申込メールサービスＩＤ */
	@Id
	@Column(nullable = true, columnDefinition ="char(10)")
	public String applySvcMailId;
	...
	/** 申込メールサービスのFinderクラス */
    public static Finder<String, ApplySvcMail> find = 
    		BaseEntity.getFinder(String.class, ApplySvcMail.class);   
