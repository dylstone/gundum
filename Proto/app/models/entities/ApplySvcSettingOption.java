 ...
 * </p>
 * @author 那須　智貴
 * @version 0.1　2014/08/06　新規作成
 */
@Entity
public class ApplySvcSettingOption extends BaseEntity {

	/** 申込設置場所サービスＩＤ */
	@Id
	@Column(nullable = true, columnDefinition ="char(10)")
	public String applySvcSettingOptionId;
    ...
    public static Finder<String, ApplySvcSettingOption> find = 
    		BaseEntity.getFinder(String.class, ApplySvcSettingOption.class);   
