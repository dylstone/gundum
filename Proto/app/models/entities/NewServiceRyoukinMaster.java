 ...
 */
@Entity
public class NewServiceRyoukinMaster extends BaseEntity {
	...
	/** サービス料金マスタのFinderクラス */
    public static Finder<String, NewServiceRyoukinMaster> find = 
    		BaseEntity.getFinder(String.class, NewServiceRyoukinMaster.class);   
