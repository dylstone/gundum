 ...
 */
@Entity
public class ServiceMaster extends BaseEntity {
	...
	/** サービス分類（※削除予定） */
    @Column(nullable = true, columnDefinition ="char(4)")
	public String serviceBunrui;

//	/** サービス分類コード */
//	@ManyToOne
//	@JoinColumn(name = "service_bunrui_cd")
//	public ServiceBunruiMaster serviceBunruiMaster;
	...
	public ServiceRyoukinMaster serviceRyoukin;

	/** サービスマスタのFinderクラス */
    public static Finder<String, ServiceMaster> find = 
    		BaseEntity.getFinder(String.class, ServiceMaster.class);   
