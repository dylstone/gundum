 ...
 */
@Entity
public class SvcKaisen extends BaseEntity {

	/** 回線サービスＩＤ */
	@Id
	@Column(nullable = true, columnDefinition ="char(10)")
	public String svcKaisenId;
	...
	/** 回線サービスのFinderクラス */
    public static Finder<String, SvcKaisen> find = 
    		BaseEntity.getFinder(String.class, SvcKaisen.class);   
