...
$(document).ready(function(){
	 ...
	 */
	 var cntlFlg = true;
	 $("#shoninTab .tabButton").each(function() {
		...
		// 確認画面の場合
		 ...
		 $("#shoninTab .tabButton:first").addClass('active').removeClass('orange');
...
$(function(){
	...
	// タブ押下イベント
	 $("#shoninTab .tabButton").click(function() {
		
		// 活性状態クラスを削除
		$('#shoninTab .tabButton').removeClass('active');
		// 押下したボタンのIDを保持しておく
