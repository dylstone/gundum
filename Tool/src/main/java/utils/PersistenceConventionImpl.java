...
public class PersistenceConventionImpl implements PersistenceConvention {
	...
	public static void main(String[] args) {
		PersistenceConventionImpl pci = new PersistenceConventionImpl();
		System.out.println(pci.fromEntityNameToTableName("helloWorld"));
		System.out.println(pci.fromTableNameToEntityName("TEST_DATA_INFO"));
		System.out.println(pci.fromColumnNameToPropertyName("TEST_DATA_INFO"));
	}
}